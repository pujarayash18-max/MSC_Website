...
import { Winner, Points, Achievement, LeaderboardEntry } from '../../../types/engagement';

export async function winnersPublish(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
