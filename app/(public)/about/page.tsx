...
import { Sparkles, Target, Eye, Award, Users, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 py-8">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="text-4xl font-extrabold text-white">Microsoft Campus Club (MCC)</h1>
      ...
      <div className="space-y-8">
        <h2 className="text-2xl font-extrabold text-white text-center">Core Pillars of Excellence</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 space-y-3">
            <BookOpen className="w-8 h-8 text-sky-400" />
            <h3 className="text-lg font-bold text-white">Azure & Cloud Mastery</h3>
            <p className="text-xs text-slate-400">Regular workshops covering Azure Functions, Cosmos DB, Containers, Bicep, and DevOps.</p>
          </Card>

          <Card className="p-6 space-y-3">
            <Users className="w-8 h-8 text-emerald-400" />
            <h3 className="text-lg font-bold text-white">Peer Mentorship</h3>
            <p className="text-xs text-slate-400">Senior student leaders and Microsoft Ambassadors mentoring junior developers.</p>
          </Card>

          <Card className="p-6 space-y-3">
            <Award className="w-8 h-8 text-amber-400" />
            <h3 className="text-lg font-bold text-white">Gamified Growth</h3>
            <p className="text-xs text-slate-400">Earn community points, unlock achievement badges, and climb the institutional leaderboard.</p>
          </Card>
        </div>
      </div>
    </div>
